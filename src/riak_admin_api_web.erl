...
i(<<"NodeRepairStatus">>) -> {riak_admin_api_ag_ctl_cluster, monitoring};
i(<<"NodeRepairStart">>) -> {riak_admin_api_ag_ctl_cluster, admin};
i(<<"NodeRepairStop">>) -> {riak_admin_api_ag_ctl_cluster, admin};
i(<<"VnodeStatus">>) -> {riak_admin_api_ag_ctl_vnode, monitoring};
...
permissions_for(<<"NodeRepairStatus">>) -> [cluster_observer];
permissions_for(<<"NodeRepairStart">>) -> [cluster_observer, cluster_admin];
permissions_for(<<"NodeRepairStop">>) -> [cluster_observer, cluster_admin];
permissions_for(<<"VnodeStatus">>) -> [cluster_observer];
